...
inquirer
    .prompt([
        ...
        {type:'checkbox', name:'age', message: 'Do you like any of these?'},
        {type:'password', name:'age', message: 'Tell me something important.'},
        {type:'editor', name:'age', message: 'How old are you?'},
    ])
    .then((answer)=>{
